...
**Purpose:** Document what Copilot CLI needs to know to implement a phase well - not just "which library" but "how do experts build this."
...
- When Copilot CLI's training data is likely stale or sparse
